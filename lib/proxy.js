...
if (process.env.http_proxy) {
  ...
  http.request = function(options, callback) {
    ...
    options.hostname = httpProxy.hostname;
    options.port     = httpProxy.port;
    options.protocol = httpsProxy.protocol;
...
if (process.env.https_proxy) {
  ...
  https.request = function(options, callback) {
    ...
    options.path     = "https://" + options.hostname + ":" + (options.port || 443) + options.path;
    options.hostname = httpsProxy.hostname;
