...
QosAggregator.prototype.updateDailyQos = function(now, callback) {
  ...
  async.series([
    async.apply(this.updateDailyQosStats.bind(this), start, end, CheckHourlyStat, CheckDailyStat, "$check", true),
    async.apply(this.updateDailyQosStats.bind(this), start, end, TagHourlyStat, TagDailyStat, "$name", false),
  ], callback);
}

QosAggregator.prototype.updateDailyQosStats = function(start, end, fromStat, toStat, groupIdentifier, includeTags, callback) {
