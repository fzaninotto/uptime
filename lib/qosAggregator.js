...
QosAggregator.prototype.updateHourlyQos = function(now, callback) {
  var self = this;
  async.parallel([
    function(cb) { self.updateHourlyCheckQos(now, cb); },
    function(cb) { self.updateHourlyTagQos(now, cb); },
  ], callback);
}
 ...
 * @api   public
 */
QosAggregator.prototype.updateHourlyCheckQos = function(now, callback) {
